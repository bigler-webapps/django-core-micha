...
### DCM-NEW-recoveryrequest-crud-fallthrough — `RecoveryRequestViewSet` accepts CRUD from any auth user
**Severity:** P2
...
### DCM-NEW-recovery-token-in-fragment — Plaintext token in redirect fragment + API response
**Severity:** P2
...
### DCM-NEW-recovery-ttl-from-creation — Recovery expiry starts at created_at, not approved_at
**Severity:** P2
...
### DCM-NEW-healthz-error-leak — DB error text returned in healthz response
**Severity:** P2
...
### DCM-NEW-account-email-verification-optional — `ACCOUNT_EMAIL_VERIFICATION = "optional"` platform default
**Severity:** P2
...
### DCM-NEW-recovery-active-deadbranch
**Severity:** P3
...
### UICORE-NEW-passwordinvite-open-redirect
**Severity:** P2
